...
def create_menu_bar(app):
 ...
 app.menu_part.add_command(label="PART verschieben", command=app.move_part)
 app.menu_part.add_command(label="PART umbenennen", command=app.rename_part)
 ...
 app.menu_part.add_command(label="PART laden", command=app.replace_part, accelerator="Strg+T")
 app.menu_part.add_command(label="PART exportieren", command=app.export_selected_part, accelerator="Strg+E")
 app.menu_part.add_command(label="PART importieren", command=app.import_part_file, accelerator="Strg+I")

 app.menu_part.add_separator()

 app.menu_part.add_command(label="TEST: PART aus Codebereich", command=app.test_create_part_from_code_range)
